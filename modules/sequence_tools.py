...
def is_dna(sequence):
    ...
    upper_seq = sequence.upper()
    return "T" in upper_seq or ("U" not in upper_seq and set(upper_seq).issubset(set("ATCG")))
...
def is_rna(sequence):
    ...
    upper_seq = sequence.upper()
    return "U" in upper_seq or ("T" not in upper_seq and set(upper_seq).issubset(set("AUCG")))
