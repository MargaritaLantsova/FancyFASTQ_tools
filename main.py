        ...
        if choice == '0':
            ...
            try:
                operation_map = {
                    ...
                    '6': ('type determination', lambda seq: "DNA" if sequence_tools.is_dna(seq) else "RNA" if sequence_tools.is_rna(seq) else "Unknown"),
...
def filter_fastq(seqs, gc_bounds=DEFAULT_GC_BOUNDS, 
    ...
    for seq_name, seq_data in seqs.items():
        if fastq_tools.filter_sequence(seq_data, gc_bounds, length_bounds, quality_threshold):
